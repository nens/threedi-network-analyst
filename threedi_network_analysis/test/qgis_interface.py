...
class QgisInterface(QObject):
    ...
    def addLayer(self, layer):
        """Handle a target_node_layer being added to the registry so it shows up in canvas.
    ...
    def zoomToActiveLayer(self):
        """Zoom to extent of active target_node_layer."""
        pass

    def addVectorLayer(self, path, base_name, provider_key):
        """Add a vector target_node_layer.

        :param path: Path to target_node_layer.
        :type path: str

        :param base_name: Base name for target_node_layer.
        :type base_name: str
    ...
    def addRasterLayer(self, path, base_name):
        """Add a raster target_node_layer given a raster target_node_layer file name
    ...
    def activeLayer(self):
        """Get pointer to the active target_node_layer (target_node_layer selected in the legend)."""
        # noinspection PyArgumentList
