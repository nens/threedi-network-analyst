...
class ThreeDiNetworkAnalyst:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'ThreeDiNetworkAnalyst_{}.qm'.format(locale))
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('ThreeDiNetworkAnalyst', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/threedi_network_analysis/icon.png'
        self.add_action(
            icon_path,
    ...
    def onClosePlugin(self):
        ...
        #print "** CLOSING ThreeDiNetworkAnalyst"
    ...
    def run(self):
        ...
        if not self.pluginIsActive:
            ...
            #print "** STARTING ThreeDiNetworkAnalyst"
            ...
            if self.dockwidget == None:
                ...
                self.dockwidget = ThreeDiNetworkAnalystDockWidget(self.iface)
